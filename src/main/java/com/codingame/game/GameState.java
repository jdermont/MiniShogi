...
public class GameState {
    ...
    public String toKey() {
        ...
        if (hands.get(0).isEmpty() && hands.get(1).isEmpty()) {
            ...
            sb.append(' ');
            List<Piece> hand1 = new ArrayList<>(hands.get(Game.FIRST_PLAYER));
            hand1.sort(Comparator.comparing(o -> o.getChr(Game.FIRST_PLAYER)));
            List<Piece> hand2 = new ArrayList<>(hands.get(Game.SECOND_PLAYER));
            hand2.sort(Comparator.comparing(o -> o.getChr(Game.SECOND_PLAYER)));
            for (Piece piece : hand1) {
                sb.append(piece.getChr(Game.FIRST_PLAYER));
            }
